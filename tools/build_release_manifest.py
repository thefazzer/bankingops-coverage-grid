...
STATIC_ARTIFACTS = {
    ...
    "docs/isda-overlap.md": "documentation",
    ...
    "specs/SPEC-07-replayable-compliance-scenario.md": "normative-specification",
    "specs/SPEC-07-compliance-scenario.md": "normative-specification",
    "specs/SPEC-07-scenario-run-ledger.md": "normative-specification",
    "specs/compliance-scenario.schema.json": "json-schema",
    "specs/scenario-run-ledger-rows.schema.json": "json-schema",
    ...
    "specs/replayable-compliance-scenario.schema.json": "json-schema",
