...
| 19 | Public rubric/benchmark/eval density on the grid is disclosed as an explained overlay, not as elicited gaps or institution coverage (BB construct validity; DS limitations; I7) | EVIDENCED | SPEC-09; `reference/public-eval-surface-map.v1.json` likelihood bands + paint rules; `reference/public-eval-choropleth.v1.md` voids vs saturation; S9 gates in `tools/gate_conformance.py` |
